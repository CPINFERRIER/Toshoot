...
namespace Cyrilastro.NINA.Toshoot.ToshootTestCategory {
    ...
    public class ToshootCondition : SequenceCondition {
        /// <summary>
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(ToshootCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}